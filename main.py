...
def main():
    ...
    input_data = generate_random_puzzles_file(number_of_puzzles, goal_state_2, row_length, column_length) # does not work with goal_state_1, why???
    print(input_data)
